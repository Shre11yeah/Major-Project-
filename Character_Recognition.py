...
def get_date_and_time(img_name):  # to detect and read, date and time from the image
    path_to_tesseract = r"C:\\Users\\user\\Desktop\\HemathThakur\\Priority-Based-Parking-System\\Tesseract-OCR\\tesseract.exe"  # mention the path of the tesseract, so that the compiler calls pytesseract from the installed directory
    ...
    croppedImage = "cropped_image.jpg"  # we give the name of the cropped image as cropped_image
    img2.save(croppedImage)  # we will save this and pass this to tesseract to read date and time
    # img2.show()
    #os.chmod(croppedImage, 0o777)
...
def get_license_plate_info(name_of_image, x_recieved, y_recieved, width_recieved, height_recieved):
    ...
    data = pytesseract.image_to_string(ROI, lang='LicensePlate',
                                       config='--psm 6 C:\\Users\\user\\Desktop\\HemathThakur\\Priority-Based-Parking-System\\custom.txt').upper()
...
#     img_name = "C:\\Users\\user\\Desktop\\HemathThakur\\Priority-Based-Parking-System\\input_images\\img0.jpg"  # Update with an actual image path
#     # img_name = "img0.jpg"
